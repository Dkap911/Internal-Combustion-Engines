...
// ********************* Calculate the performance parameters of Four Cylinder ********************************
// *********************** Four Stroke Diesel Engine with Hydraulic Dynamometer **********************************

printf("Calculate the Performance Parameters of Four Cylinder Four Stroke Diesel Engine with Hydraulic Dynamometer\n");
printf("\n");

// ************* Specifications ****************
printf("************* Specifications ****************\n");
printf("Engine Type: Four-Stroke, Four - Cylinder Water - Cooled Diesel Engine of Ashok Leyland\n");
printf("No. of Cylinder: Four\n");
printf("Engine Capacity: 2080 cc\n");
printf("Compression Ratio: 18:1\n");
printf("Calorific Value of Fuel (Diesel): 45200 kJ/kg\n");
printf("Specific Gravity of Fuel: 0.82 gm/cc\n");
printf("Dynamometer Arm Length: 358.2 mm\n");

// ************* Basic Information ****************
d = 85 // Bore Diameter in mm
L = 92 // Stroke Length in mm
D = 35 // Diameter of Orifice in mm
CV = 45200 // Calorific Value of Petrol in kJ/kg
Pf = 0.82 // Specific Gravity of Petrol
Cpw = 4.186 // Specific Heat of water
Cd = 0.65 // Co-efficient of Discharge
P = 101325 // Atmospheric Pressure in kN/m2
g = 9.81 // Acceleration due to Gravity in m/s2
r = 18.1 // Compression Ratio
CC = 2080 // Engine Capacity CC
// ************************************************

// ********************** Observations ***************************
N = 1540 // Engine Speed
C = 2000 // Dynamometer Constant
W = 25.5 // Effective Load on the Engine
T = 4.06 // Time taken in seconds for Consumption of 5 cc of Petrol
Mw = 6 // Water Flow to Engine in Litre/minute
T1 = 25 // Water Inlet Temperature to Calorimeter in C
T2 = 36 // Water Outlet Temperature from Calorimeter in C
T3 = 370 // Exhaust Gas Outlet Temperature from Engine in C
T4 = 292 // Exhaust Gas Inlet Temperature to Calorimeter in C
T5 = 107 // Exhaust Gas Outlet Temperature from Calorimeter in C
T6 = 36 // Water Inlet Temperature to Engine in C
T7 = 58 // Water Outlet Temperature from Engine in C
T8 = 26 // Atmospheric Temperature in C
Hw = 85 // Pressure Difference in U-Tube Manometer in mm
// ***************************************************************
printf("\n");
